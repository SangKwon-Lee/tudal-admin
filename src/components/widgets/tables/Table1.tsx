...
const orders = [
  ...
  },
  {
    ...
    createdAt: subHours(
      subMinutes(subSeconds(now, 50), 12),
      2,
    ).getTime(),
    customer: {
  ...
  },
  {
    ...
    createdAt: subHours(
      subMinutes(subSeconds(now, 12), 39),
      5,
    ).getTime(),
    customer: {
  ...
  },
  {
    ...
    createdAt: subHours(
      subMinutes(subSeconds(now, 21), 46),
      5,
    ).getTime(),
    customer: {
  ...
  },
  {
    ...
    createdAt: subHours(
      subMinutes(subSeconds(now, 54), 19),
      8,
    ).getTime(),
    customer: {
  ...
  },
  {
    ...
    createdAt: subDays(
      subMinutes(subSeconds(now, 12), 45),
      1,
    ).getTime(),
    customer: {
